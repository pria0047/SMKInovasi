...
import pria.com.smkinovasi.adapter.CustomAdapter;
...
public class OlehFragment extends Fragment {
    ...
    int[] thumbnail = {R.drawable.a, R.drawable.a, R.drawable.a};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_oleh, container, false);
        rootView.setTag(TAG);
